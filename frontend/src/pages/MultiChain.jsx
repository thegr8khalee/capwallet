...
const MultiChain = ({ setPageLoading }) => {
  ...
  const upcomingChains = [
    'Avalanche', 'Arbitrum', 'Optimism', 'TON', 'Cosmos',
    'Sui', 'Aptos', 'Near Protocol', '100 more in progress'
  ];
  ...
  return (
    ...
    <div className="pt-24">{/*Hero Section */}
      ...
      >
        ...
        {/* Core Chains */}
        <div className="mb-12">
          <h3 className="text-2xl font-semibold text-secondary mb-6">Core Chains</h3>
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
            {coreChains.map((chain, index) => (
              ...
              >
                <img src={`${chain.logo}`} alt={chain.name} className="mx-auto mb-4 w-20" />
