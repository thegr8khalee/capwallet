...
const Support = () => {
      ...
      items: [
        {
          ...
          answer: 'Cap Wallet is an AI-powered, non-custodial multi-chain crypto wallet that lets you store, send, receive, swap, and manage digital assets securely. Your keys stay on your device, and AI protects you from scams and risky transactions.',
        },
        {
          question: 'How to create your first wallet',
          answer: 'Download Cap Wallet → Tap Create Wallet → Write down your recovery phrase → Confirm the phrase in order → Enable biometrics for secure access.',
        },
        {
          question: 'Backing up & securing your recovery phrase',
          answer: 'Write your recovery phrase on paper and store it offline in a safe, private location. Never store it on your phone or cloud storage. Never share it with anyone, including support.',
        },
        {
          question: 'Restoring your wallet on a new device',
          answer: 'Open Cap Wallet → Tap Restore Wallet → Enter your recovery phrase exactly as shown → Set up biometrics or PIN → Your assets will appear automatically.',
        },
        {
          question: 'Supported blockchains & assets',
          answer: 'Cap Wallet supports Bitcoin, Solana, Ethereum, BSC, Polygon, and many more. New chains are added regularly. Most tokens based on these networks (ERC-20, SPL, BEP-20, etc.) are supported automatically.',
        },
        {
          question: 'Understanding how self-custody works',
          answer: 'Self-custody means you control your private keys, not us. We cannot recover your wallet, access your funds, or reverse transactions. You are in full control.',
        },
      ],
    },
    {
      ...
      items: [
        {
          ...
          answer: 'Local key storage (Secure Enclave/Keystore), biometric authentication, AI-powered scam detection, real-time risk warnings, device-level encryption, and dApp permission clarity.',
        },
        {
          question: 'Understanding self-custody (what we can and cannot do)',
          answer: 'We can help with guidance. We cannot access your wallet, keys, seeds, or transactions.',
        },
        {
          question: 'AI scam detection & transaction risk checks',
          answer: 'AI analyzes addresses, smart contracts, transaction patterns, token authenticity, and dApp reputation. If something looks risky, you get a warning before signing.',
        },
        {
          question: 'How to avoid phishing & fake websites',
          answer: 'Only download from official links, bookmark the Cap Wallet site, never enter your recovery phrase into any website, and double-check URLs and certificates.',
        },
        {
          question: 'What to do if you interacted with a scam',
          answer: 'Immediately stop signing transactions, move remaining funds to a new wallet, disconnect all dApps, and contact security@capwallet.com.',
        },
        {
          question: 'Emergency steps if you suspect an attack',
          answer: 'Disable Wi-Fi/mobile data, turn off your device and restart, create a new wallet, transfer assets, and contact the Security Desk.',
        },
      ],
    },
    {
      ...
      items: [
        {
          ...
          answer: 'To send: Select asset → Send → Paste address or scan QR → Confirm with AI security check → Approve & sign. To receive: Select asset → Receive → Share your address or QR.',
        },
        {
          question: 'Cross-chain swaps & bridges',
          answer: 'Choose "Swap" → select From/To chains → AI finds the safest & cheapest route → Review → Approve.',
        },
        {
          question: 'AI fee optimization',
          answer: 'AI suggests the best network fee to ensure fast + cost-efficient delivery.',
        },
        {
          question: 'Viewing your portfolio & insights',
          answer: 'Go to Portfolio to see total value, asset breakdown, historical performance, and AI insights.',
        },
        {
          question: 'Common transaction errors & fixes',
          answer: '"Insufficient funds" → Add more network gas. "Transaction dropped" → Try higher fee. "Nonce too low" → Use "Speed Up" or "Reset Nonce". "Network busy" → Retry after a few minutes.',
        },
        {
          question: 'Connecting to dApps from mobile',
          answer: 'Use the built-in dApp browser or use WalletConnect, then approve the connection request.',
        },
        {
          question: 'Connecting via browser extension',
          answer: 'Click "Connect Wallet" on the dApp, then approve or deny permissions.',
        },
        {
          question: 'Approving/denying dApp permissions',
          answer: 'Only approve read-only, view balance, and sign messages you understand. Avoid unverified contracts and unlimited token approvals (unless necessary).',
        },
        {
      ...
      items: [
        {
          ...
          answer: 'Get it from Chrome Web Store, Brave Add-ons, or Edge Extensions Marketplace.',
        },
        {
          question: 'Supported browsers: Chrome, Brave, Edge',
          answer: 'Cap Wallet extension is officially supported on Chrome, Brave, and Microsoft Edge browsers.',
        },
        {
        ...
        },
        {
          ...
          answer: 'If enabled, sync uses encrypted data; your keys never leave your device.',
        },
        {
          question: 'Connecting the wallet to dApps',
          answer: 'Click "Connect" on the dApp → Approve connection in the popup.',
        },
        {
        ...
        },
        {
          ...
          answer: 'Review amount, contract, fee, and AI safety score, then sign.',
        },
        {
          question: 'Only install from official store links',
          answer: 'Never download extensions from random sites. Always use official browser stores.',
        },
        {
        ...
        },
        {
          ...
          answer: 'Refresh the page, restart browser, and ensure correct network is selected.',
        },
        {
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          answer: 'Transaction obfuscation (if available), stealth addresses, and private mode.',
        },
        {
          question: 'Introduction to Dark Pool trading',
          answer: 'Private off-book trades for large-volume traders. Quotes (RFQs) are private and do not affect market prices.',
        },
        {
          question: 'Who can access Dark Pool mode',
          answer: 'Cap Wallet Pro users, institutions, and high-volume traders (subject to KYC).',
        },
        {
          question: 'Compliance & analytics tools',
          answer: 'Spend limits, audit logs, role-based access, and reporting dashboard.',
        },
      ],
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          answer: 'Enable FaceID/TouchID or set a 6-digit PIN for quick access.',
        },
        {
        ...
        },
        {
          ...
          answer: 'Control price alerts, transaction confirmations, and security alerts.',
        },
        {
          question: 'How we protect your data (privacy overview)',
          answer: 'No PII required, no seed phrases stored, minimal anonymous analytics, and strong encryption.',
        },
      ],
    },
  ];
  ...
  const filteredSections = helpCenterSections.map(section => {
  ...
  return (
    <div className="">
      ...
      >
        ...
        >
          We're here to keep your crypto safe, your questions answered, and your experience smooth—24/7.
        </motion.p>
        {/* <motion.p
            ...
            {filteredSections.length === 0 ? (
              ...
              <div className="space-y-6">
                <p className="text-gray-600 text-sm mb-4">
                  Found {filteredSections.reduce((acc, section) => acc + section.items.length, 0)} result(s)
                </p>
                      ...
                      {section.items.map((item, itemIndex) => (
                        ...
                        >
                          <motion.button
                            ...
                            onClick={() =>
                              setExpandedQuestion(
                                expandedQuestion.section === sectionIndex && expandedQuestion.index === itemIndex
                                  ? { section: null, index: null }
                                  : { section: sectionIndex, index: itemIndex }
                              )
                            }
                          >
                            <span className="text-lg font-medium text-secondary">{item.question}</span>
                            <motion.div
                              animate={{
                                rotate: expandedQuestion.section === sectionIndex && expandedQuestion.index === itemIndex ? 180 : 0,
                              }}
        ...
        {!searchQuery && (
          <>
            ...
            >
              <a href="#security" className="hover:text-primary transition-colors">Security Desk</a>
              <span>•</span>
              <a href="#status" className="hover:text-primary transition-colors">System Status</a>
              <span>•</span>
              <a href="#browser-extension" className="hover:text-primary transition-colors">Browser Extension Help</a>
            </motion.div>
          </>
        )}
      </motion.section>
            ...
            >
              <motion.button
                ...
                onClick={() =>
                  setExpandedQuestion({
                    section: 0,
                    index: expandedQuestion.section === 0 && expandedQuestion.index === index ? null : index
                  })
                }
              >
                <h3 className="text-lg font-semibold text-secondary">{item.question}</h3>
                <motion.div
                  animate={{ rotate: expandedQuestion.section === 0 && expandedQuestion.index === index ? 180 : 0 }}
                  transition={{ duration: 0.3 }}
                >
              ...
              <AnimatePresence>
                {expandedQuestion.section === 0 && expandedQuestion.index === index && (
                  <motion.div
                    initial={{ height: 0, opacity: 0 }}
                    animate={{ height: 'auto', opacity: 1 }}
                    exit={{ height: 0, opacity: 0 }}
      ...
      >
        <div className="mb-12">
          ...
          <p className="text-xl text-gray-600">
            Security is built into every layer. Your keys stay with you. Our AI checks everything.
          </p>
        </div>
            ...
            >
              <motion.button
                ...
                onClick={() =>
                  setExpandedQuestion({
                    section: 1,
                    index: expandedQuestion.section === 1 && expandedQuestion.index === index ? null : index
                  })
                }
              >
                <h3 className="text-lg font-semibold text-secondary">{item.question}</h3>
                <motion.div
                  animate={{ rotate: expandedQuestion.section === 1 && expandedQuestion.index === index ? 180 : 0 }}
                  transition={{ duration: 0.3 }}
                >
                  <ChevronDown className="text-gray-400 size-5 shrink-0" />
                </motion.div>
              ...
              <AnimatePresence>
                {expandedQuestion.section === 1 && expandedQuestion.index === index && (
                  <motion.div
                    initial={{ height: 0, opacity: 0 }}
                    animate={{ height: 'auto', opacity: 1 }}
                    exit={{ height: 0, opacity: 0 }}
      ...
      >
        <div className="mb-12">
          ...
          <p className="text-xl text-gray-600">
            Learn how to use your wallet across both the mobile app and the browser extension.
          </p>
        </div>
            ...
            >
              <motion.button
                ...
                onClick={() =>
                  setExpandedQuestion({
                    section: 2,
                    index: expandedQuestion.section === 2 && expandedQuestion.index === index ? null : index
                  })
                }
              >
                <h3 className="text-lg font-semibold text-secondary">{item.question}</h3>
                <motion.div
                  animate={{ rotate: expandedQuestion.section === 2 && expandedQuestion.index === index ? 180 : 0 }}
                  transition={{ duration: 0.3 }}
                >
                  <ChevronDown className="text-gray-400 size-5 shrink-0" />
                </motion.div>
              ...
              <AnimatePresence>
                {expandedQuestion.section === 2 && expandedQuestion.index === index && (
                  <motion.div
                    initial={{ height: 0, opacity: 0 }}
                    animate={{ height: 'auto', opacity: 1 }}
                    exit={{ height: 0, opacity: 0 }}
            ...
            >
              <motion.button
                ...
                onClick={() =>
                  setExpandedQuestion({
                    section: 3,
                    index: expandedQuestion.section === 3 && expandedQuestion.index === index ? null : index
                  })
                }
              >
                <h3 className="text-lg font-semibold text-secondary">{item.question}</h3>
                <motion.div
                  animate={{ rotate: expandedQuestion.section === 3 && expandedQuestion.index === index ? 180 : 0 }}
                  transition={{ duration: 0.3 }}
                >
                  <ChevronDown className="text-gray-400 size-5 shrink-0" />
                </motion.div>
              ...
              <AnimatePresence>
                {expandedQuestion.section === 3 && expandedQuestion.index === index && (
                  <motion.div
                    initial={{ height: 0, opacity: 0 }}
                    animate={{ height: 'auto', opacity: 1 }}
                    exit={{ height: 0, opacity: 0 }}
            ...
            >
              <motion.button
                ...
                onClick={() =>
                  setExpandedQuestion({
                    section: 4,
                    index: expandedQuestion.section === 4 && expandedQuestion.index === index ? null : index
                  })
                }
              >
                <h3 className="text-lg font-semibold text-secondary">{item.question}</h3>
                <motion.div
                  animate={{ rotate: expandedQuestion.section === 4 && expandedQuestion.index === index ? 180 : 0 }}
                  transition={{ duration: 0.3 }}
                >
                  <ChevronDown className="text-gray-400 size-5 shrink-0" />
                </motion.div>
              ...
              <AnimatePresence>
                {expandedQuestion.section === 4 && expandedQuestion.index === index && (
                  <motion.div
                    initial={{ height: 0, opacity: 0 }}
                    animate={{ height: 'auto', opacity: 1 }}
                    exit={{ height: 0, opacity: 0 }}
            ...
            >
              <motion.button
                ...
                onClick={() =>
                  setExpandedQuestion({
                    section: 5,
                    index: expandedQuestion.section === 5 && expandedQuestion.index === index ? null : index
                  })
                }
              >
                <h3 className="text-lg font-semibold text-secondary">{item.question}</h3>
                <motion.div
                  animate={{ rotate: expandedQuestion.section === 5 && expandedQuestion.index === index ? 180 : 0 }}
                  transition={{ duration: 0.3 }}
                >
                  <ChevronDown className="text-gray-400 size-5 shrink-0" />
                </motion.div>
              ...
              <AnimatePresence>
                {expandedQuestion.section === 5 && expandedQuestion.index === index && (
                  <motion.div
                    initial={{ height: 0, opacity: 0 }}
                    animate={{ height: 'auto', opacity: 1 }}
                    exit={{ height: 0, opacity: 0 }}
        ...
        <div className="bg-gradient-to-br from-accent/10 to-primary/10 rounded-3xl p-4 py-8 md:p-12">
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-8">
            ...
            >
              ...
              <h3 className="text-xl font-bold text-secondary mb-2">In-App Chat</h3>
            ...
            >
              ...
              <h3 className="text-xl font-bold text-secondary mb-2">Email Support</h3>
              <p className="text-primary text-lg font-semibold mb-2">support@capwallet.com</p>
              <p className="text-gray-600">We try to respond within a few hours.</p>
            </motion.div>
          </div>
          ...
          <div className="bg-yellow-50 border border-yellow-200 rounded-xl p-6">
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="font-bold text-gray-900 mb-2">Important Note</p>
                <p className="text-gray-700">
                  We will <strong>never</strong> ask for your recovery phrase or private keys.
                  If anyone asks for them claiming to be Cap Wallet Support—it is a <strong>scam</strong>.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="mt-8 p-6 bg-white rounded-xl">
            <h3 className="text-lg font-bold text-secondary mb-4">For Browser Extension Issues</h3>
      ...
      >
        <div className="bg-red-50 rounded-3xl p-4 py-8 md:p-12 border-2 border-red-200">
          ...
          <div className="bg-white rounded-2xl p-6 mb-6">
            ...
            <p className="text-red-600 text-2xl font-bold mb-3">security@capwallet.com</p>
            <p className="text-gray-700">
              Include addresses involved, transaction hash, screenshots, and a clear explanation.
            </p>
          </div>

          <div className="bg-red-600 text-white rounded-2xl p-6 mb-6">
            <h3 className="text-xl font-bold mb-4">If You Suspect an Attack:</h3>
            <ol className="space-y-3">
              ...
              <li className="flex items-start gap-3">
                ...
                <span>Move funds to a new wallet with a fresh recovery phrase</span>
              </li>
              <li className="flex items-start gap-3">
          ...
          <div className="bg-gray-100 rounded-xl p-6">
            <h3 className="text-lg font-bold text-secondary mb-2">For Security Researchers</h3>
            <p className="text-gray-700">
              We support responsible disclosure. Please give us time to investigate before going public.
            </p>
          </div>
        </div>
      </motion.section>
      ...
      >
        <div className="bg-gray-50 rounded-3xl p-4 py-8 md:p-12">
          ...
          <div className="mt-6 p-4 bg-blue-50 border border-blue-200 rounded-xl">
            <p className="text-gray-700">
              <strong>Example:</strong> Swaps & Bridges – ⚠️ Slower than usual.
              <br />
      ...
      >
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600">
            Help us build Cap Wallet for the world.
          </p>
        </div>
        
        <div className="grid grid-cols-2 md:grid-cols-3 gap-6 mb-8">
          {[
            { name: 'Telegram Community', icon: MessageCircle, color: 'text-blue-500' },
            { name: 'Discord Server', icon: Users, color: 'text-indigo-500' },
            { name: 'X (Twitter)', icon: Globe, color: 'text-sky-500' },
          ].map((platform, index) => (
            <motion.a
              key={index}
              href="#"
              className="p-6 bg-white rounded-2xl border border-gray-200 text-center hover:border-accent transition-all cursor-pointer group"
            ...
            >
              <platform.icon className={`${platform.color} size-12 mx-auto mb-3`} />
